package com.example.fintechapp.CustomSlider;
...
import static com.example.fintechapp.CustomSlider.Util.spToPx;
...
public class SlideView extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    protected LinearLayout arrowLinearLayout;
    ...
    void init(AttributeSet attrs, int defStyle) {
        ...
        // Initialize arrowLinearLayout
        arrowLinearLayout = findViewById(R.id.arrow);
        ...
        try {
            ...
            setButtonBackgroundColor(Objects.requireNonNull(a.getColorStateList(R.styleable.SlideView_sv_buttonBackgroundColor)));
            setSlideBackgroundColor(Objects.requireNonNull(a.getColorStateList(R.styleable.SlideView_sv_slideBackgroundColor)));
    ...
    public void hideArrowLinearLayout() {
        if (slider.getProgress() > 50) {
            arrowLinearLayout.setVisibility(View.GONE);
        } else {
            arrowLinearLayout.setVisibility(View.VISIBLE);
        }
    }
